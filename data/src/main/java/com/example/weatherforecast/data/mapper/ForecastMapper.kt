...
import com.example.weatherforecast.core.data.local.entity.DailyForecastEntity
import com.example.weatherforecast.core.data.remote.dto.ForecastDto
...
object ForecastMapper {
    fun ForecastDto.toEntities(cityId: Int? = null, cityName: String? = null): List<DailyForecastEntity> {
        val dailyForecasts = mutableMapOf<String, MutableList<com.example.weatherforecast.core.data.remote.dto.ForecastItemDto>>()
